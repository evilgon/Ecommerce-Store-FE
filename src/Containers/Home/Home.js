        ...
        <div className={styles.container}>
          <div className={styles.left}>
            ...
            <div className={styles.buttons}>
              ...
              <a
                href="https://github.com/evilgon/Ecommerce-Store-FE"
                target="_blank"
              >
              ...
              <a href="https://www.linkedin.com/in/evilgon/" target="_blank">
                <button
          ...
          <div className={styles.right}>
            <div className={styles.buttonsRight}>
              ...
              <a
                href="https://github.com/evilgon/Ecommerce-Store-FE/commits/main"
                target="_blank"
              >
              ...
              <a
                href="https://github.com/evilgon/Ecommerce-Store-FE/blob/main/README.md#performance"
                target="_blank"
              >
                <button
                  className={`${styles.cta} ${styles.lastChild}`}
              ...
              <a
                href="https://github.com/evilgon/Ecommerce-Store-FE/blob/main/README.md#technologies-used"
                target="_blank"
              >
                <button
                  className={`${styles.cta} ${styles.lastChild}`}
              ...
              <a
                href="https://github.com/evilgon/Ecommerce-Store-FE/blob/main/README.md#sources"
                target="_blank"
              >
                <button
                  className={`${styles.cta} ${styles.lastChild}`}
